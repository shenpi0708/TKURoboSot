...
class Robot(object):
  ...
  def __init__(self, sim = False):
    ...
    robot1_sub = message_filters.Subscriber('/robot1/strategy/state', RobotState)
    ...
    robot2_subshoot = message_filters.Subscriber("/robot2/requestsignal", Bool)
    robot3_subshoot = message_filters.Subscriber('/robot3/requestsignal', Bool)
